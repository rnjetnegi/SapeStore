  ...
  */
  ...
  public String getContactUs() throws SapeStoreException {
    ...
    try {
      ...
      LOGGER.fatal(
          "A DB exception occured while getting the contact us details",
          dbe);
      throw dbe;
    }
  ...
  */
  ...
  public String getPolicy() throws SapeStoreException {
    ...
    try {
      ...
      LOGGER.fatal(
          "A DB exception occured while getting the policy details",
          dbe);
      throw dbe;
    }
  ...
  */
  ...
  public void setContactUs(String text) throws SapeStoreException {
    ...
    try {
      ...
      LOGGER.fatal(
          "A DB exception occured while saving the contact us details",
          dbe);
      throw dbe;
    }
