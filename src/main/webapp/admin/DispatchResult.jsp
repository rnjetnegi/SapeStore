...
<!-- 						</div> -->
	...
	<div class="col-sm-9 padding-right">
		<div class="features_items">
				<!--features_items-->
<!-- 				<h2 class="title text-center">Dispatch Slip</h2> -->
				<section style="height: 650px; margin-bottom: 20px;">
				
					<script>
			function printDiv(divName) {
				 
// 			     var title = document.getElementById(divName).style.display = "block";
			     ...
			     WinPrint.close();
					...
					<h2 id="title" class="title center-text" style="text-align: center;">Dispatch Slip</h2>
					...
					<table class="tableT" style="width: 100%;">
						...
						<c:forEach items="${dispatchedOrder}" var="current">

							<tr>

								<td class="bookTitle_td" style="width: 20%">
									${current.customerName}</td>
								<td class="bookTitle_td" style="width: 20%">
									${current.orderNumber}</td>
								<td class="bookTitle_td" style="width: 20%">
									${current.orderItemNumber}</td>
								<td class="publisherName_td" style="width: 20%">${current.addressLine1},${current.addressLine2},
									${current.cityName}, ${current.stateName}</td>
						</c:forEach>
						</tr>
