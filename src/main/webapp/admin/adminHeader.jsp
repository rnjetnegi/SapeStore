...
<!--[if lt IE 9]>
    ...
    <![endif]-->
<link rel="shortcut icon" href="/SapeStore/images/ico/favicon.ico">
<link rel="apple-touch-icon-precomposed" sizes="144x144"
	href="/SapeStore/images/ico/apple-touch-icon-144-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114"
	href="/SapeStore/images/ico/apple-touch-icon-114-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72"
	href="/SapeStore/images/ico/apple-touch-icon-72-precomposed.png">
<link rel="apple-touch-icon-precomposed"
	href="/SapeStore/images/ico/apple-touch-icon-57-precomposed.png">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="${pageContext.request.contextPath}/admin"><img src="/SapeStore/images/home/logo.png" alt="" /></a>
						</div>
					</div>
				<%-- 	<div class="col-sm-4">
