						...
						<section>
							...
							<div id="tabbed">
								<ul class="nav nav-tabs">
									<li class=""><a href="/SapeStore/admin/policyEdit">Privacy
											Policy</a></li>
									<li class="active"><a href="/SapeStore/admin/contactUsEdit">Contact Us Page</a></li>
								</ul>
										...
										<div id="div1"
											...
											<form:form action="/SapeStore/admin/policy">
												<input type="hidden" name="hiddenText" id="hiddenText"
													value="${policyText}" />
												<textarea id="policyText" name="policyText" class="form-control"
													rows="10"
...
<!-- 											<div id="message1"></div> -->
											<div align="left"
												...
												<button id="savePolicy" onclick="makeCall()"
