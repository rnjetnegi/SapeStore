...
public class AccountControllerTest {
	...
	public void testBeforeLogin() {
		try {
			LOGGER.info("entered testBeforeLogin");
			mockMvc = MockMvcBuilders.webAppContextSetup(wac).build();
			final ResultActions RESULT=mockMvc.perform(get("/index"));
			RESULT.andExpect(status().isOk());
			LOGGER.info("exited testBeforeLogin");
		} catch (Exception e) {
			e.printStackTrace();
		}		
	}
...
//		try {
//			LOGGER.info("entered testLogin");
//			mockMvc = MockMvcBuilders.webAppContextSetup(wac).build();
//			final ResultActions RESULT=mockMvc.perform(post("/login"));
//			RESULT.andExpect(status().isOk());
//			LOGGER.info("exited testLogin");
//		} catch (Exception e) {
//			e.printStackTrace();
//		}		
		assertTrue(true);
...
//			mockMvc = MockMvcBuilders.webAppContextSetup(wac).build();
//			final ResultActions RESULT=mockMvc.perform(get("/logout"));
//			
